...
const app = {
    ...
    songsData : [
        ...
        {
            background: './assets/img/songs/buonhayvui.jpg',
            name: 'Buồn Hay khóc',
            singer: 'MCK, VSOUL,OBITO.BONGMINZ',
            pathSong: './assets/music/list-song/buồn_hay_vui.mp3',
            duration : '03:51',
        },
        {
            background: './assets/img/songs/querry.jpg',
            name: 'QUERRY',
            singer: 'Trung Trần, MCK, QNT',
            pathSong: './assets/music/list-song/querry.mp3',
            duration : '03:51',
        },
        {
            background: './assets/img/songs/sauloikhuoctu.jpg',
            name: 'Sau Lời Từ khước',
            singer: 'Phan Mạnh Quỳnh',
            pathSong: './assets/music/list-song/sauloikhuoctu.mp3',
            duration : '04:10',
        },
        {
            background: './assets/img/songs/jack.jpg',
            name: 'Thiên Lý ơi',
            singer: 'Jack 5 củ',
            pathSong: './assets/music/list-song/jack.mp3',
            duration : '01:29',
        },
    ],
    currentIndex : 0,
        ...
        if (toatMain) {
            ...
            toast.innerHTML = `
                <div class="toast__item">
                    ...
                    <span>Chức năng này chưa được phát triển, bạn vui lòng thử lại sau !</span>
                </div>
            `;
